...
import { Brain, Activity, Gauge, Ruler, ClipboardList, X } from "lucide-react"
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 md:px-8 lg:px-12 bg-white">
        <div className="max-w-6xl mx-auto">
            ...
            {escalas.map((e, i) => (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-2">
                  <h3
                    className="text-2xl sm:text-3xl font-bold text-[#6B8E23]"
                    style={{ fontFamily: "var(--font-playfair)" }}
                  >
                    {e.sigla} — {e.titulo}
                  </h3>
          ...
          >
            <h3
              className="text-2xl font-bold text-[#1f2923] mb-3"
              style={{ fontFamily: "var(--font-playfair)" }}
            >
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 md:px-8 lg:px-12 bg-[#F8F9FA]">
        <div className="max-w-6xl mx-auto">
          ...
          <p
            className="text-[#445345] max-w-3xl leading-relaxed"
            style={{ fontFamily: "var(--font-poppins)" }}
          >
