  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-[#E3F0E2] via-[#F0F5EF] to-white pt-32 pb-20 px-4 sm:px-6 md:px-8 lg:px-12 overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10 mt-72">
        ...
        <div
          className="absolute inset-0 bg-[url('/688b3849-9449-4c97-8be2-0a28c28ef3f0.png')] bg-center bg-contain bg-no-repeat opacity-10 mix-blend-multiply pointer-events-none"
          style={{
            filter: "brightness(0.8) contrast(1.1)",
            backgroundSize: "100%", // ajusta o tamanho do cérebro (pode testar 60–80%)
          }}
        />
      </section>
            ...
            {features.map((f, i) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-2xl sm:text-3xl font-bold" style={{ color: f.accent, fontFamily: "var(--font-playfair)" }}>
                    {f.title}
                  </h3>
      ...
      <section id="sobre" className="py-16 sm:py-20 px-4 sm:px-6 md:px-8 lg:px-12 bg-[#F8F9FA]">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-[#445345] max-w-3xl leading-relaxed mb-10" style={{ fontFamily: "var(--font-poppins)" }}>
      ...
      <section className="relative bg-gradient-to-b from-[#F6FBF5] to-[#E8F4E7] px-4 sm:px-6 md:px-8 lg:px-12 py-24 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto space-y-16">
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#2F3E2F] mb-6" style={{ fontFamily: "var(--font-playfair)" }}>
              De onde surgiu a ideia?
            </h2>
            <p className="text-[#374151] leading-relaxed" style={{ fontFamily: "var(--font-poppins)" }}>
              O projeto nasceu durante o estágio em Fisioterapia Neurofuncional, quando identificamos lacunas práticas na execução de testes.
              Reunimos, em um só lugar, conteúdo confiável e acessível para apoiar estudantes e estagiários.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100">
            ...
            <p className="text-[#374151] leading-relaxed" style={{ fontFamily: "var(--font-poppins)" }}>
              Base bibliográfica atualizada em semiologia neurológica e vídeos demonstrativos dos principais testes, além de suporte técnico para a construção do site.
            </p>
      ...
      <section id="contato" className="py-16 sm:py-20 px-4 sm:px-6 md:px-8 lg:px-12 bg-gradient-to-br from-[#6B8E23] to-[#556B2F]">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white" style={{ fontFamily: "var(--font-playfair)" }}>
              Fale com a gente
            </h2>
          </div>
